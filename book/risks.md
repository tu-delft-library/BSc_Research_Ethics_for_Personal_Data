...
4. **Membership in a trade union**: Participating (or not participating) in a trade union can lead members (or non-members) to be shunned by fellow workers and managers. If a participant's union status were leaked, they could be discriminated against in the workplace.  
...
Read the scenario, then evaluate potential risks in this research project as it's currently designed. 
<br>
